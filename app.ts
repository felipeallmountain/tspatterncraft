import IPattern from './src/IPattern';
import StrategyPatternDemo from './src/strategy/StrategyPatternDemo';
import StatePatternDemo from './src/state/StatePatternDemo';
import VisitorPatternDemo from './src/visitor/VisitorPatternDemo';
